...
import com.longngohoang.news.appcore.data.source.remote.NYTimesRemoteDataSource;
...
public class ArticleRepositoryImpl implements ArticleRepository {
    private static final String TAG = "ArticleRepositoryImpl";
    ...
    @Inject
    public ArticleRepositoryImpl(NYTimesRemoteDataSource NYTimesRemoteDataSource) {
